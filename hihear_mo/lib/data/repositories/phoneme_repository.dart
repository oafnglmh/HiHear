...
class PhonemeRepository {
  ...
  static const consonants = [
    ...
    Phoneme(symbol: 'nh', example: 'nhà nhà', tts: 'nhờ'),
    Phoneme(symbol: 'ng', example: 'ngà ngà', tts: 'ngờ'),
    Phoneme(symbol: 'ngh', example: 'nghê nghê', tts: 'nghờ'),
    ...
    Phoneme(symbol: 'th', example: 'tha tha', tts: 'thờ'),
    Phoneme(symbol: 'tr', example: 'tra tra', tts: 'trờ'),
