...
mixin _$LessionEntity {
 ...
 String get id; String get title; String get category; String get level; String get description; int get durationSeconds; int? get xpReward; String? get prerequisiteLesson;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,category,level,description,durationSeconds,xpReward,prerequisiteLesson);

@override
String toString() {
  return 'LessionEntity(id: $id, title: $title, category: $category, level: $level, description: $description, durationSeconds: $durationSeconds, xpReward: $xpReward, prerequisiteLesson: $prerequisiteLesson)';
}
...
@useResult
$Res call({
 String id, String title, String category, String level, String description, int durationSeconds, int? xpReward, String? prerequisiteLesson
});
...
/// Create a copy of LessionEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? category = null,Object? level = null,Object? description = null,Object? durationSeconds = null,Object? xpReward = freezed,Object? prerequisiteLesson = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String category,  String level,  String description,  int durationSeconds,  int? xpReward,  String? prerequisiteLesson)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LessionEntity() when $default != null:
return $default(_that.id,_that.title,_that.category,_that.level,_that.description,_that.durationSeconds,_that.xpReward,_that.prerequisiteLesson);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String category,  String level,  String description,  int durationSeconds,  int? xpReward,  String? prerequisiteLesson)  $default,) {final _that = this;
switch (_that) {
case _LessionEntity():
return $default(_that.id,_that.title,_that.category,_that.level,_that.description,_that.durationSeconds,_that.xpReward,_that.prerequisiteLesson);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String category,  String level,  String description,  int durationSeconds,  int? xpReward,  String? prerequisiteLesson)?  $default,) {final _that = this;
switch (_that) {
case _LessionEntity() when $default != null:
return $default(_that.id,_that.title,_that.category,_that.level,_that.description,_that.durationSeconds,_that.xpReward,_that.prerequisiteLesson);case _:
  return null;
...
class _LessionEntity implements LessionEntity {
  const _LessionEntity({required this.id, required this.title, required this.category, required this.level, required this.description, required this.durationSeconds, this.xpReward, this.prerequisiteLesson});
...
/// Create a copy of LessionEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? category = null,Object? level = null,Object? description = null,Object? durationSeconds = null,Object? xpReward = freezed,Object? prerequisiteLesson = freezed,}) {
