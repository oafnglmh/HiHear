...
mixin _$LessionEntity {
 ...
 String get id; String get title; String get category; String get level; String get description; int get durationSeconds; int? get xpReward; String? get prerequisiteLessonId; bool get isLock; List<MediaEntity> get media; List<ExerciseEntity> get exercises;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,category,level,description,durationSeconds,xpReward,prerequisiteLessonId,isLock,const DeepCollectionEquality().hash(media),const DeepCollectionEquality().hash(exercises));

@override
String toString() {
  return 'LessionEntity(id: $id, title: $title, category: $category, level: $level, description: $description, durationSeconds: $durationSeconds, xpReward: $xpReward, prerequisiteLessonId: $prerequisiteLessonId, isLock: $isLock, media: $media, exercises: $exercises)';
}
...
@useResult
$Res call({
 String id, String title, String category, String level, String description, int durationSeconds, int? xpReward, String? prerequisiteLessonId, bool isLock, List<MediaEntity> media, List<ExerciseEntity> exercises
});
...
/// Create a copy of LessionEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? category = null,Object? level = null,Object? description = null,Object? durationSeconds = null,Object? xpReward = freezed,Object? prerequisiteLessonId = freezed,Object? isLock = null,Object? media = null,Object? exercises = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String category,  String level,  String description,  int durationSeconds,  int? xpReward,  String? prerequisiteLessonId,  bool isLock,  List<MediaEntity> media,  List<ExerciseEntity> exercises)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LessionEntity() when $default != null:
return $default(_that.id,_that.title,_that.category,_that.level,_that.description,_that.durationSeconds,_that.xpReward,_that.prerequisiteLessonId,_that.isLock,_that.media,_that.exercises);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String category,  String level,  String description,  int durationSeconds,  int? xpReward,  String? prerequisiteLessonId,  bool isLock,  List<MediaEntity> media,  List<ExerciseEntity> exercises)  $default,) {final _that = this;
switch (_that) {
case _LessionEntity():
return $default(_that.id,_that.title,_that.category,_that.level,_that.description,_that.durationSeconds,_that.xpReward,_that.prerequisiteLessonId,_that.isLock,_that.media,_that.exercises);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String category,  String level,  String description,  int durationSeconds,  int? xpReward,  String? prerequisiteLessonId,  bool isLock,  List<MediaEntity> media,  List<ExerciseEntity> exercises)?  $default,) {final _that = this;
switch (_that) {
case _LessionEntity() when $default != null:
return $default(_that.id,_that.title,_that.category,_that.level,_that.description,_that.durationSeconds,_that.xpReward,_that.prerequisiteLessonId,_that.isLock,_that.media,_that.exercises);case _:
  return null;
...
class _LessionEntity implements LessionEntity {
  const _LessionEntity({required this.id, required this.title, required this.category, required this.level, required this.description, required this.durationSeconds, this.xpReward, this.prerequisiteLessonId, this.isLock = true, final  List<MediaEntity> media = const [], final  List<ExerciseEntity> exercises = const []}): _media = media,_exercises = exercises;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,category,level,description,durationSeconds,xpReward,prerequisiteLessonId,isLock,const DeepCollectionEquality().hash(_media),const DeepCollectionEquality().hash(_exercises));
...
/// Create a copy of LessionEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? category = null,Object? level = null,Object? description = null,Object? durationSeconds = null,Object? xpReward = freezed,Object? prerequisiteLessonId = freezed,Object? isLock = null,Object? media = null,Object? exercises = null,}) {
